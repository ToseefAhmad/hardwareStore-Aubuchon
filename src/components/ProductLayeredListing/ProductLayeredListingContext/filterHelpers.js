...
export const sortFiltersArray = initialArray => {
    return initialArray.sort((a, b) => {
        const aIndex = FILTERS_ORDER.indexOf(a['attribute_code']);
        const bIndex = FILTERS_ORDER.indexOf(b['attribute_code']);
 ...
 * @param {Set} values
 * @todo Set up "are" filtering instead of "in".
 */
 ...
 * @todo Should this throw error instead of removing the filter from URL?
 */
