...
const setQueryParam = ({
    ...
    // this check will add additional parameters on each page except first to remove '?page=1' from url
...
export const usePagination = (props = {}) => {
    ...
    const currentPage =
        parseInt(getSearchParam(searchParam, location)) || initialPage;
    ...
    const setCurrentPage = useCallback(
        ...
        [history, initialPage, location, searchParam]
    );
